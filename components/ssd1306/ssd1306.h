...
/**
 * @brief Print to OLED
 * @param X position in X-axis (from 1 to 16)
 * @param Y position in Y-axis (a.k.a page, from 0 to 7)
 */
void printSreenText(SSD1306_t *dev, uint8_t X, uint8_t Y, char *data);
/**
 * @brief Print center a text
 * 
 * @param dev SSD1306
 * @param Y page
 * @param data text
...
/**
 * @brief Print a integer number
 * 
 * @param dev SSD1306
 * @param X xPos
 * @param Y yPas (page)
 * @param num integer number
 * @param num_digit max number of digit want to print
 */
